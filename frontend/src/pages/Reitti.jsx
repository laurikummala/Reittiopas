...
import { haeReitti, poistaReitti } from '../features/reitit/reittiSlice'
...
function Reitti() {
  ...
  const { reittiOlio, isLoading, isError, message} = useSelector((state) => state.reitit)
  ...
  useEffect(() => {
    ...
    // haetaan vain yksi reitti, joka tallentuu reittiOlio nimellä state.reitit-tilaan
